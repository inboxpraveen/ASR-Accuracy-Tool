...
All notable changes to the Speech Annotation Tool will be documented in this file.
...
Enhanced Speech Annotation Tool with background processing, modern UI, and comprehensive documentation.
