...
All notable changes to the Speech Annotation Workbench will be documented in this file.
...
Enhanced Speech Annotation Workbench with background processing, modern UI, and comprehensive documentation.
